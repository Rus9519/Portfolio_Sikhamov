...
| [Предсказание цены автомобиля по историческим данным](https://github.com/Rus9519/Portfolio_Sikhamov/tree/main/Boosting_Car_Price_Prediciton) | Создание модели машинного обучения для предсказания цены поддержанных автомобилей | Градиентный бустинг |
