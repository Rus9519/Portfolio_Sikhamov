...
| **Название проекта** | **Описание** | **Тематика** |
| :------------------- | :----------- | :----------- |
| [Анализ потребления алкоголя студентами средней школы](https://github.com/Rus9519/Portfolio_Sikhamov/tree/main/Students_Alcohol_Consumption_EDA%2Bgrade_prediction) | Анализ факторов, влияющих на успеваемость студентов математического класса (в том числе потребление алкоголя) | EDA, регрессия |
